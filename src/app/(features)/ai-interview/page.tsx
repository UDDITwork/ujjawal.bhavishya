...
export const metadata: Metadata = {
  ...
  description:
    'Practice job interviews with IKLAVYA\'s AI interviewer. Get real-time feedback on confidence, communication and content to ace your next interview.',
  keywords: ['AI mock interview', 'interview practice', 'interview simulator', 'job interview preparation', 'AI interviewer'],
  openGraph: {
    title: 'AI Mock Interview Simulator — IKLAVYA',
