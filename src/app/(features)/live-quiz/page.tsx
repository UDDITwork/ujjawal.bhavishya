...
export const metadata: Metadata = {
  ...
  description:
    'Compete in real-time quiz competitions on UJJWAL BHAVISHYA. Test your knowledge, climb the leaderboard, and win badges in gamified learning battles.',
  keywords: ['live quiz', 'quiz competition', 'gamified learning', 'online quiz', 'leaderboard'],
  openGraph: {
    title: 'Live Quiz Arena — UJJWAL BHAVISHYA',
