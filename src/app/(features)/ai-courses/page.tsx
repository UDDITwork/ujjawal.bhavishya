...
export const metadata: Metadata = {
  ...
  description:
    'Master soft skills, communication, leadership and more with IKLAVYA\'s AI-curated video courses designed for career success.',
  keywords: ['online courses', 'soft skills training', 'communication course', 'leadership training', 'video learning'],
  openGraph: {
    title: 'AI-Powered Video Courses — IKLAVYA',
